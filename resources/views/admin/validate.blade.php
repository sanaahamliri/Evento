                    ...
                    <div class="w-full overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody>
                                ...
                                @foreach($UnValidEvents as $evento)
                                <tr class="border">
                                    <td class="border p-2">{{$evento->title}}</td>
                                    <td class="border p-2">{{$evento->place}}</td>
                                    <td class="border p-2">{{$evento->date}}</td>
                                    <td class="border p-2">{{$evento->place_number}}</td>
